                ...
                <div id="form-main">
					<div id="form-div">
						<form name="form1" action="contact.php" method="POST" class="form" id="form1">
							...
							<p class="name">
								<input name="yourname" type="text" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input" placeholder="Name" id="name1" />
                                <span class="error"><p id="name_error"></p></span>
							</p>
                           
					<p class="text">
								<input name="subject" class="validate[required,length[6,300]] feedback-input" id="subject" placeholder="Subject"/> 
